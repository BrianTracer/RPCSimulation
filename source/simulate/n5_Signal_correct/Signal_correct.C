...
int main(int argc, char * argv[]) {
  ...
  gRandom->SetSeed(12456); //233 //245 //189  //257
 
  double alpha, eta, vx, vy, vz;
  ifstream input_stream1("town.txt");         //40.7eV/cm
  ifstream input_stream2("vdrift.txt");       //40.7eV/cm
...
/////////////////////////////////////////////////////////////////////////////////
 ...
 //   cout << "t_aval[iStep] = " << t_aval[iStep] << endl;
  ...
  const double thickness_bakelite = 0.18, permitivity_bakelite = 10;
...
//  hT->Fill(ievent);
  ...
  TProfile *hprof = new TProfile("hprof","Profile of T versus TOT",100,0,80,0,25);
...
//  hc->Fit("gaus");
  ...
  efficiency = (double)nevents_cut/nevents;

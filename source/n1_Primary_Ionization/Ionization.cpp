...
int main(int argc, char * argv[]) {
  ...
  TH1F* hxc = new TH1F("hxc", "track", 100, -0.1, 2.1);
  TH1F* hyc = new TH1F("hyc", "Y-axis", 300, -10., 10.);
  TH1F* hzc = new TH1F("hzc", "Z-axis", 300, -10., 10.);
  TH1F* htc = new TH1F("htc", "t-axis", 100, -0.001, 0.01);
  TH1F* hnc = new TH1F("hnc", "Cluster Size", 100,0., 300.);
  TH1F* hNc = new TH1F("hNc", "Number of Clusters", 50, 0., 50.);
  TH1F* hxe = new TH1F("hxe", "track of electrons", 200, -0.1, 2.1);
  ...
  TFile *fcluster = new TFile("cluster.root","RECREATE");
  //空间分布

...
int main(int argc, char * argv[]) {
  ...
  gRandom->SetSeed(443567); //233 //245 //189  //257
...
//    cout << "t_aval[iStep] = " << t_aval[iStep] << endl;
 ...
 //   }
  ...
  const double gap = 0.15, thickness_insulatingfilm = 0.03, permitivity_insulatingfilm = 3.3;
...
//  hT->Fill(ievent);
 ...
 // cout << "ievent = " << ievent << ", T = " << T[ievent] << ", TOT = " << TOT[ievent] << endl;   
  ...
  TProfile *hprof = new TProfile("hprof","Profile of T versus TOT",100,0,120,0,25);  // 0,70

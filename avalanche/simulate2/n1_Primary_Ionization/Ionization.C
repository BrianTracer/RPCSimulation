...
int main(int argc, char * argv[]) {
  ...
  const double width = 0.1;  //Unit[cm]                 //11111111111111111111111111111111111111111111111111111111
  ...
  TFile *fcluster = new TFile("cluster1mm.root","RECREATE");
  //空间分布

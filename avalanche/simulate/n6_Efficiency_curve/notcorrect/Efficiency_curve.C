...
/////////////////////////////////////////////////////////////////////////////////
  ...
  double vdrift = vdrift_Ef[i_vol];  //[cm/ns]
  double kratio = beta_Ef[i_vol] / alpha_Ef[i_vol];
 ...
 // cout << "kratio = " << kratio <<endl;
  ...
  double Astep = exp( (alpha_Ef[i_vol] - beta_Ef[i_vol])*dStep );
...
//  hT->Fill(ievent);
  ...
  TProfile *hprof = new TProfile("hprof","Profile of T versus TOT",100,0,70,0,25);
